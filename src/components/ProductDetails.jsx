    ...
    <main className='product-details'>
      <div className='product-details__container container'>
        <div className='product-details__description'>
          <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptatem laboriosam ratione repellat eligendi esse deserunt non voluptatum doloremque explicabo ullam.</p>
        </div>
